...
public static class AutoUpdater
{
    public static bool CheckUpdate(string MyCurrentVersion)
    {
        ...
        double timeSinceLastUpdate = elapsedTicks - WholesomeFlightMasterDeepSettings.CurrentSettings.LastUpdateDate;
        ...
        try
        {
            WholesomeFlightMasterDeepSettings.CurrentSettings.LastUpdateDate = elapsedTicks;
